...
def consolidate_config(
    ...
    Example::
        ...
        value = {
            "topic_to_pubsub": {
                "standard": "projects/my-project/topics/yaas-enact-standard-request",
                "yaas": "projects/my-project/topics/yaas-enact-standard-request",
                "gcs": "projects/my-project/topics/yaas-enact-gcs-batch-request"
            },
            "topic_to_pubsub_gcs": "gs://my-bucket/yaas/topic_to_pubsub"
        }
        print("gs://my-bucket/yaas/topic_to_pubsub/my-new-topic") == "projects/my-new-project/topics/yaas-enact-my-new-topic"
    ...
    Then after this you will have::
        ...
        value = {
            "topic_to_pubsub": {
                ...
                "yaas": "projects/my-project/topics/yaas-enact-standard-request",
                "gcs": "projects/my-project/topics/yaas-enact-gcs-batch-request",
                "my-new-topic": "projects/my-new-project/topics/yaas-enact-my-new-topic"
            },
            "topic_to_pubsub_gcs": "gs://my-bucket/yaas/topic_to_pubsub"
        }

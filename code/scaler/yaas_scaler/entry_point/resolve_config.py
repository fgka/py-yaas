...
def consolidate_config(
    ...
    Example::
        ...
        value = {
            "topic_to_pubsub": {
                "standard": "projects/my-project/topics/yaas-scaler-scheduler-common-enact-standard-request",
                "yaas-scaler-scheduler-common": "projects/my-project/topics/yaas-scaler-scheduler-common-enact-standard-request",
                "gcs": "projects/my-project/topics/yaas-scaler-scheduler-common-enact-gcs-batch-request"
            },
            "topic_to_pubsub_gcs": "gs://my-bucket/yaas-scaler-scheduler-common/topic_to_pubsub"
        }
        print("gs://my-bucket/yaas-scaler-scheduler-common/topic_to_pubsub/my-new-topic") == "projects/my-new-project/topics/yaas-scaler-scheduler-common-enact-my-new-topic"
    ...
    Then after this you will have::
        ...
        value = {
            "topic_to_pubsub": {
                ...
                "yaas-scaler-scheduler-common": "projects/my-project/topics/yaas-scaler-scheduler-common-enact-standard-request",
                "gcs": "projects/my-project/topics/yaas-scaler-scheduler-common-enact-gcs-batch-request",
                "my-new-topic": "projects/my-new-project/topics/yaas-scaler-scheduler-common-enact-my-new-topic"
            },
            "topic_to_pubsub_gcs": "gs://my-bucket/yaas-scaler-scheduler-common/topic_to_pubsub"
        }

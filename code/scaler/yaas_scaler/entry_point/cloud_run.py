...
async def enact_gcs_requests() -> str:
    ...
    Create GCS profile::
        ...
        PROFILE_PREFIX="yaas-scaler-scheduler-common/scaling_profiles"
...
def _main():
    ...
    To test::
        ...
        export CONFIG_OBJECT_PATH=yaas-scaler-scheduler-common.cfg
        python -m yaas-scaler-scheduler-common.entry_point.cloud_run
    """

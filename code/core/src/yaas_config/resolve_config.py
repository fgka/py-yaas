...
"""Act on the ``topic_to_pubsub_gcs`` to resolve extra topics on
:py:class:`config.Config`."""
from typing import Optional

from yaas_common import const, logger
from yaas_config import config
from yaas_gcp import gcs, pubsub

_LOGGER = logger.get(__name__)


def consolidate_config(value: config.Config, *, raise_if_failed: Optional[bool] = True) -> config.Config:
    ...
    Example::
        ...
        value = {
            "topic_to_pubsub": {
                "standard": "projects/my-project/topics/yaas_gcp-scaler-scheduler_service-common-enact-standard-request",
                "yaas_gcp-scaler-scheduler_service-common": "projects/my-project/topics/yaas_gcp-scaler-scheduler_service-common-enact-standard-request",
                "gcs": "projects/my-project/topics/yaas_gcp-scaler-scheduler_service-common-enact-gcs-batch-request"
            },
            "topic_to_pubsub_gcs": "gs://my-bucket/yaas_gcp-scaler-scheduler_service-common/topic_to_pubsub"
        }
        print("gs://my-bucket/yaas_gcp-scaler-scheduler_service-common/topic_to_pubsub/my-new-topic") == "projects/my-new-project/topics/yaas_gcp-scaler-scheduler_service-common-enact-my-new-topic"
    ...
    Then after this you will have::
        ...
        value = {
            "topic_to_pubsub": {
                ...
                "yaas_gcp-scaler-scheduler_service-common": "projects/my-project/topics/yaas_gcp-scaler-scheduler_service-common-enact-standard-request",
                "gcs": "projects/my-project/topics/yaas_gcp-scaler-scheduler_service-common-enact-gcs-batch-request",
                "my-new-topic": "projects/my-new-project/topics/yaas_gcp-scaler-scheduler_service-common-enact-my-new-topic"
            },
            "topic_to_pubsub_gcs": "gs://my-bucket/yaas_gcp-scaler-scheduler_service-common/topic_to_pubsub"
        }
...
def _consolidate_config_with_topic_to_pubsub_gcs(  # pylint: disable=invalid-name
    value: config.Config,
) -> config.Config:

...
# pylint: disable=missing-module-docstring,invalid-name,protected-access,
# type: ignore
import re
...
def test_validate_resource_name_ok(value: str, tokens: List[str], amount: int):
    # Given/When
    result = resource_name.validate_resource_name(value=value, tokens=tokens, raise_if_invalid=False)
    # Then
...
def test_validate_resource_name_nok_raise():
    with pytest.raises(ValueError):
        resource_name.validate_resource_name(value=None, tokens=[], raise_if_invalid=True)

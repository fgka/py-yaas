...
async def command() -> str:
    ...
    async_kwargs_fn = lambda event: dict(
    ...
    return await cloud_run.handle_request(
        what="command", async_kwargs_fn=async_kwargs_fn, async_fn=async_fn)
...
async def update_cache() -> str:
    ...
    async_kwargs_fn = create_kwargs
    async_fn =entry.update_cache
    return  await cloud_run.handle_request(
        what="update_cache", async_kwargs_fn=async_kwargs_fn, async_fn=async_fn)
...
async def send_requests() -> str:
    ...
    return  await cloud_run.handle_request(
        what="send_requests"
        , async_kwargs_fn=async_kwargs_fn, async_fn=async_fn)

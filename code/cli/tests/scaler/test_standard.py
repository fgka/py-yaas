...
class TestStandardScalingCommandParser:
    ...
    @pytest.mark.parametrize(
        ...
        [
            request.ScaleRequest(
                topic="standard",
                resource="locations/europe-west3/namespaces/yaas_gcp-scaler-scheduler-common-test/services/integ-test",
            ...
            request.ScaleRequest(
                topic="standard",
                resource="yaas_gcp-scaler-scheduler-common-test:europe-west3:integ-test",

...
_TEST_CLOUD_RUN_CANONICAL: str = resource_regex_const.CLOUD_RUN_RESOURCE_NAME_TMPL.format(
...
_TEST_CLOUD_RUN_SIMPLE: str = _TEST_CLOUD_RUN_SIMPLE_TMPL.format(_TEST_PROJECT, _TEST_LOCATION, _TEST_CLOUD_RUN_SERVICE)
# Cloud SQL
_TEST_CLOUD_SQL_INSTANCE: str = "my_instance"
_TEST_CLOUD_SQL_CANONICAL: str = resource_regex_const.CLOUD_SQL_RESOURCE_NAME_TMPL.format(

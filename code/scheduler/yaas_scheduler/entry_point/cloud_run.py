...
async def enact_gcs_requests() -> str:
    ...
    Create GCS profile::
        ...
        PROFILE_PREFIX="yaas_gcp-scaler-scheduler-common/scaling_profiles"
...
def _main():
    ...
    To test::
        ...
        export CONFIG_OBJECT_PATH=yaas_gcp-scaler-scheduler-common.cfg
        python -m yaas_gcp-scaler-scheduler-common.entry_point.cloud_run
    """
